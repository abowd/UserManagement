        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_UserGroups_UserGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasksId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTasks_Tasks_TasksId",
                        column: x => x.TasksId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "452c96a3-d30c-4b5b-b064-3ad14e4e2dbe", "Admin", null },
                    { "2", "89b9b323-b436-43d5-a0d6-dcd08f4bf2e3", "User", null }
                });
